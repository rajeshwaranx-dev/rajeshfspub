...
# ✅ Prevent duplicate /start processing per user
...
async def start_command(client: Client, message: Message):
    ...
    # ✅ If already processing this user, ignore the duplicate
    if id in processing_users:
        return
    processing_users.add(id)
